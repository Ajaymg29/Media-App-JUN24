...
function Footer() {
  return (
    <div style={{height:'300px'}} className='container mt-5 w-100 bg-warning'>
    <div className='footer-content d-flex justify-content-between '>
      <div style={{width:'400px'}} className="media">
        <h5 className='mb-3'><i className='fa-solid fa-music fa-beat me-3 fs-5'></i>
        Media Player
        </h5>
        <p style={{textAlign:'justify',color:'white'}}>Designed and built with all the love in the world by the Bootstrap team with the help of our contributors</p>
